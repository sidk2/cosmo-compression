...
param_est_path: str = "cosmo_compression/parameter_estimation/data/best_model_full_img.pth"
...
# Load models
fm: lightning.LightningModule = represent.Represent.load_from_checkpoint("img-lat-128ch/step=step=31000-val_loss=0.348.ckpt").to(device)
fm.eval()
