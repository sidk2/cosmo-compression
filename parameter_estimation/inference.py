...
class CompressionDataset(Dataset):
    def __init__(self):
        super().__init__()
        self.x = torch.tensor(np.load('cosmo_compression/parameter_estimation/data/latents.npy'))
        self.y = torch.tensor(np.load('cosmo_compression/parameter_estimation/data/params.npy'))
        print(self.y.shape)
    ...
    def __getitem__(self, index):
        return self.x[index], self.y[index][0][2:4]
...
train_data, val_data = random_split(dataset, [14000, 1000])
